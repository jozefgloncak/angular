...
const routes: Routes = [
    ...
    { path: 'table/mat-table', loadChildren: 'app/ordinary-table-demo-module/ordinary-table-demo.module#OrdinaryTableDemoModule' },
    { path: 'table/lst-table', loadChildren: 'app/list-table-demo-module/list-table-demo.module#ListTableDemoModule' },
